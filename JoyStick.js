 ...
 * 用于控制物体移动和转向的摇杆控件
 * props: {
 *  container, // 放置JoyStick的Dom容器
 *  game, // 调用者
 *  onMove, // 移动或转向的回调函数，返回{forward, turn}
 *  maxRadius,
 *  rotationDamping,
 *  moveDamping,
 * }
...
export default class JoyStick {
  constructor(props) {
    ...
    document.getElementById(props.container || "joystick_ctrl").appendChild(circle);
